...
**2. Создаёте бота во ВКонтакте или Telegram и получаете их токены**  
...
**5. Создаёте во ВКонтакте или Telegram группу и добавляете туда бота (или добавляете в уже существующую группу**  
**6. Отправляете код из пункта 4 в группу во ВКонтакте или Telegram**  
Готово! Теперь все сообщения, приходящие в подключённый чат в MAX, будут пересылаться в привязанный групповой чат во ВКонтакте или Telegram
...
2. Откройте Devtools в браузере (обычно клавиша F12 или Ctrl+Shift+I)
